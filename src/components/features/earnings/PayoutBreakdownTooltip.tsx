    ...
    <Tooltip>
      ...
      <TooltipContent className="max-w-xs bg-white p-3 text-slate-900 shadow-lg border">
        <div className="space-y-1.5 text-sm">
          ...
          <div className="flex justify-between gap-4">
            <span className="text-slate-600">Platform Fee ({feePercentage}%):</span>
            <span className="font-medium text-red-600">-{formatCHF(platformFee)}</span>
          </div>
          <div className="border-t border-slate-200 pt-1.5">
            <div className="flex justify-between gap-4">
              <span className="font-medium text-slate-900">Your Payout:</span>
              <span className="font-semibold text-emerald-600">{formatCHF(netPayout)}</span>
            </div>
          </div>
        </div>
      </TooltipContent>
