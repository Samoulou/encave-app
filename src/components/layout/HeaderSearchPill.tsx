...
export function HeaderSearchPill() {
  return (
    <Link
      ...
      aria-label="Rechercher des experiences dans le Valais pour au moins 2 personnes"
    >
      ...
      <span
        ...
        aria-hidden="true"
      />
      <span className="truncate">Experiences disponibles</span>
      <span
        className="mx-3 hidden h-[18px] w-px shrink-0 bg-stone-200 xl:block"
        aria-hidden="true"
      />
      <span className="hidden truncate text-ink-500 xl:inline">2+ places</span>
