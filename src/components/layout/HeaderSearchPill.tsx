...
export async function HeaderSearchPill() {
  const t = await getTranslations('nav.searchPill');
  ...
  return (
    ...
    >
      ...
      <span className="ml-2.5 truncate">{t('region')}</span>
      <span
      ...
      <span
        ...
        aria-hidden="true"
      />
      <span className="hidden truncate text-ink-500 xl:inline">
        {t('spots')}
      </span>
