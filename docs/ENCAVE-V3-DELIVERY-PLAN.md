...
| P-16   | Hardening & launch             |     | tous       | 29.5 h | S16-S17    | 🟨     | PR-1 `claude/p-16-ci-tests` (CI/e2e/k6/LHCI/axe) · PR-2 `claude/p-16-auth-hardening` (gaps P-14) · PR-3 `claude/p-16-launch-hardening` · PR-4 perf (sécable) ; plan : [P-16-hardening-launch.md](./plans/P-16-hardening-launch.md)                                                             |
