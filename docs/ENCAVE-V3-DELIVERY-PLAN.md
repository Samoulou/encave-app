...
| P-06.5 | Nettoyage « ultra clean »    |     | —          | ~8 h   | S8         | 🟨     | `claude/p-06-5-cleanup` — plan : [P-06.5-cleanup.md](./plans/P-06.5-cleanup.md) ; interstitiel : ARCHITECTURE.md + dead code + archive docs + CI dev verte |
