...
> **Statut** : en cours — PR-1 #118 (CI verte), PR-2 #119 (fixes Codex poussés, attend validation preview G-1 par Sam), PR-3 #120 (code complet + fixes revue Codex), PR-4 #121 (code complet, basée sur #120) · **Branches** : `claude/p-16-ci-tests` (PR-1) · `claude/p-16-auth-hardening` (PR-2) · `claude/p-16-launch-hardening` (PR-3) · `claude/p-16-perf-should` (PR-4)
