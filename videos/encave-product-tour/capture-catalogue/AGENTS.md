# Expériences viticoles | EnCave | EnCave

Source: http://127.0.0.1:4100/fr/experiences
...
| `extracted/tokens.json` | Design tokens: 20 colors, 6 fonts, 20 headings, 1 CTAs |
...
- **Colors**: #1A0F12 (accent), #E5D2D6 (surface-light), #FFFFFF (bg-light), #FDFCFA (bg-light), #3A2429 (surface-dark), #FBF8F4 (bg-light), #E5D2D7 (surface-light), #FBF9F9 (bg-light), #915564 (accent), #F4F1EC (bg-light)
- **Fonts**: __Nunito_ba5569 (400,500,600,700,800), __Averia_Serif_Libre_f9b7b8 (400,700), __Mukta_Vaani_ebcb76 (400,500,600,700), __Averia_Serif_Libre_4be659 (400), __JetBrains_Mono_b32614 (400,500,700), Helvetica Neue (400)
