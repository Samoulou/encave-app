...
## Linear Integration & Branch Convention
...
2. Create branch: `git checkout -b samuel/enc-XX-slug`
3. Make commits with conventional format: `feat(enc-XX): description`
4. PR title must include: `ENC-XX: Description`
5. PR description should include: `Fixes ENC-XX` for auto-close on merge